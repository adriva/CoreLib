    ...
    public class AnalyticsServerMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            if (HttpMethods.IsPost(request.Method))
            {
                ...
                var envelopeItems = NdJsonSerializer.Deserialize<Envelope>(inputStream, this.Options.EnableRequestLogging, this.Logger, AnalyticsServerMiddleware.JsonSerializerSettings).ToList();
