...
{
    internal class DependencyItemPopulator : AnalyticsItemPopulator
    {
        ...
        public override bool TryPopulate(Envelope envelope, ref AnalyticsItem analyticsItem)
        {
            ...
            if (dependencyData.Properties.TryGetString("InputHeaders", out string inputHeaders)) dependencyItem.InputHeaders = inputHeaders;
            if (dependencyData.Properties.TryGetString("OutputHeaders", out string outputHeaders)) dependencyItem.OutputHeaders = outputHeaders;
