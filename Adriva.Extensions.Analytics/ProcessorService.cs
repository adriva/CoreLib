...
namespace Adriva.Extensions.Analytics
{
    internal class ProcessorService : IHostedService, IDisposable
    {
        ...
        private readonly SqlServerAnalyticsStore Store;

        private readonly CancellationTokenSource CancellationTokenSource;
        private readonly WaitHandle[] ProcessorWaitHandles;

        public ProcessorService(IServiceProvider serviceProvider, ILogger<ProcessorService> logger)
        {
            this.Logger = logger;
            ...
            this.Store = ActivatorUtilities.CreateInstance<SqlServerAnalyticsStore>(serviceProvider);
        }
