...
namespace Adriva.Extensions.Documents
{
    public struct CellReference
    {
        ...
        public static string GetColumnName(uint columnIndex)
        {
            ...
            {
                --columnIndex;
                var index = columnIndex % ExcelColumnsAlphabet.Length;
                buffer.Insert(0, CellReference.ExcelColumnsAlphabet[(int)index]);
                columnIndex = columnIndex / (uint)CellReference.ExcelColumnsAlphabet.Length;
            }
