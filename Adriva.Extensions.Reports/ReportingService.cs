...
namespace Adriva.Extensions.Reports
{
    ...
    internal sealed class ReportingService : IReportingService
    {
        ...
        public async Task<ValueType> ExecuteQueryAsync(string name, string queryName, FilterValues filterValues)
        {
            ...
            if (!dataSources.TryGetValue(reportDefinition.Output.DataSource, out IDataSource dataSource))
            {
