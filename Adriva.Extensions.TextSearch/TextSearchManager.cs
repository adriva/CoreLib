...
namespace Adriva.Extensions.TextSearch
{
    public abstract class TextSearchManager : IDisposable
    {
        ...
        private async Task CreateIndexFileAsync(bool forceCreate, bool storeIndexInMemory)
        {
            SpinWait.SpinUntil(() => storeIndexInMemory || 0 == Interlocked.Read(ref this.ActiveSearchCount));
        ...
        {
            await this.CreateIndexFileAsync(forceCreateIndex, storeIndexInMemory);
